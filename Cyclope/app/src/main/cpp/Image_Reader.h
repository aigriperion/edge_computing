...
#ifndef CYCLOPE_IMAGE_READER_H
#define CYCLOPE_IMAGE_READER_H
...
private:
    ...
    void ConvertYUV420ToRGBA(AImage *image, cv::Mat &outRGBA);

    void BlitCenterCropToBuffer(ANativeWindow_Buffer *buf, const cv::Mat &srcRGBA);
    ...
    cv::Mat rgbaScratch_;
    cv::Mat rgbaRotScratch_;
    bool loggedOnce_ = false;
};


#endif //CYCLOPE_IMAGE_READER_H
